                    ...
                    <div class="row justify-content-center">
                        ...
                        @foreach ($certifications as $certification)
                            <div class="col-sm-10 col-md-5 col-lg-3 col-10 card p-3">
                                <img class="img-fluid" src="{{ asset('storage/'.$certification->img) }}" alt="">
                    ...
                    <a href="#"></a>
                        ...
                        @foreach ($proyects as $proyect)
                            <div class="col-sm-10 col-md-5 col-lg-3 col-10 card p-2">
                                <img class="img-fluid" src="{{ asset('storage/'.$proyect->img) }}" alt="">
                                ...
                                @foreach ($skills as $skill)
                                    @if ($skill->type == $skills_types[$i]->type)
                                        <div class="skill m-2 col-md-3 col-5">
                                            ...
                                            @endauth
                                            <img class="skill_img" src="{{ asset('storage/'.$skill->img) }}"
                                                alt="{{ $skill->name }}">
